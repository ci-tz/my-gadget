...
def getTraceInfo(tracefile):
  ...
  out.write("Max Write Size: {} KB, Min Write Size: {} KB\n".format(write_max_size * 512 / 1024, write_min_size * 512 /1024.0))
  out.write("Max Read Size: {} KB, Min Read Size: {} KB\n".format(read_max_size * 512 /1024, read_min_size * 512 /1024.0))
  out.write("\n")
  out.write("Max Write Offset: {} KB, Min Write Offset: {} KB, Span {} KB\n".format(write_max_offset * 512/1024, write_min_offset*512/1024, (write_max_offset - write_min_offset)*512/1024))
  out.write("Max Read Offset: {} KB, Min Read Offset: {} KB, Span {} KB\n".format(read_max_offset * 512/1024, read_min_offset*512/1024, (read_max_offset - read_min_offset)*512/1024))
  out.write("Max Offset: {} KB, Min Offset: {} KB, Span {} KB\n".format(max_offset * 512 /1024, min_offset * 512 / 1024, (max_offset - min_offset)*512/1024))
  out.write("\n")
